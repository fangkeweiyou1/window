...
import com.jetinno.window.draggable.BaseDraggable;
import com.jetinno.window.draggable.MovingDraggable;
...
public class EasyWindow implements Runnable {
     ...
     * 取消所有正在显示的悬浮窗
     */
    public static synchronized void cancel(EasyWindow easyWindow) {
        easyWindow.cancel();
    }
     ...
     * 回收所有正在显示的悬浮窗
     */
    public static synchronized void recycle(EasyWindow easyWindow) {
        easyWindow.recycle();
    }
     ...
     * 判断当前是否有悬浮窗正在显示
     */
    public static synchronized boolean existShowing(EasyWindow easyWindow) {
     ...
     * 设置悬浮窗口标记
     */
    public EasyWindow setTag(String tag) {
        mTag = tag;
        return this;
    }
     ...
     * 设置悬浮窗宽度
     */
    public EasyWindow setWidth(int width) {
     ...
     * 设置悬浮窗高度
     */
    public EasyWindow setHeight(int height) {
     ...
     * 设置悬浮窗显示的重心
     */
    public EasyWindow setGravity(int gravity) {
     ...
     * 设置水平偏移量
     */
    public EasyWindow setXOffset(int px) {
        mWindowParams.x = px;
        postUpdate();
        post(() -> {
            if (mDraggable != null) {
     ...
     * 设置垂直偏移量
     */
    public EasyWindow setYOffset(int px) {
        mWindowParams.y = px;
        postUpdate();
        post(() -> {
            if (mDraggable != null) {
     ...
     * 设置悬浮窗外层是否可触摸
     */
    public EasyWindow setOutsideTouchable(boolean touchable) {
     ...
     */
    public EasyWindow setBackgroundDimAmount(float amount) {
     ...
     * 添加窗口标记
     */
    public EasyWindow addWindowFlags(int flags) {
     ...
     * 移除窗口标记
     */
    public EasyWindow removeWindowFlags(int flags) {
        mWindowParams.flags &= ~flags;
        postUpdate();
        return this;
    }
     ...
     * 设置窗口标记
     */
    public EasyWindow setWindowFlags(int flags) {
        mWindowParams.flags = flags;
        postUpdate();
        return this;
    }
     ...
     * 设置悬浮窗的显示类型
     */
    public EasyWindow setWindowType(int type) {
     ...
     * 设置动画样式
     */
    public EasyWindow setAnimStyle(int id) {
     ...
     */
    public EasyWindow setSoftInputMode(int mode) {
     ...
     * 设置悬浮窗 Token
     */
    public EasyWindow setWindowToken(IBinder token) {
     ...
     * 设置悬浮窗透明度
     */
    public EasyWindow setWindowAlpha(float alpha) {
     ...
     * 设置垂直间距
     */
    public EasyWindow setVerticalMargin(float verticalMargin) {
     ...
     * 设置水平间距
     */
    public EasyWindow setHorizontalMargin(float horizontalMargin) {
     ...
     * 设置位图格式
     */
    public EasyWindow setBitmapFormat(int format) {
     ...
     * 设置状态栏的可见性
     */
    public EasyWindow setSystemUiVisibility(int systemUiVisibility) {
     ...
     * 设置垂直权重
     */
    public EasyWindow setVerticalWeight(float verticalWeight) {
     ...
     * 设置挖孔屏下的显示模式
     */
    public EasyWindow setLayoutInDisplayCutoutMode(int mode) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
     ...
     * 设置悬浮窗在哪个显示屏上显示
     */
    public EasyWindow setPreferredDisplayModeId(int id) {
     ...
     * 设置悬浮窗标题
     */
    public EasyWindow setWindowTitle(CharSequence title) {
     ...
     * 设置屏幕的亮度
     */
    public EasyWindow setScreenBrightness(float screenBrightness) {
     ...
     * 设置按键的亮度
     */
    public EasyWindow setButtonBrightness(float buttonBrightness) {
     ...
     * 设置悬浮窗的刷新率
     */
    public EasyWindow setPreferredRefreshRate(float preferredRefreshRate) {
     ...
     * 设置悬浮窗的颜色模式
     */
    public EasyWindow setColorMode(int colorMode) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
     ...
     */
    public EasyWindow setScreenOrientation(int orientation) {
     ...
     */
    public EasyWindow setWindowParams(WindowManager.LayoutParams params) {
     ...
     * 设置随意拖动
     */
    public EasyWindow setDraggable() {
     ...
     * 设置拖动规则
     */
    public EasyWindow setDraggable(BaseDraggable draggable) {
     ...
     * 限定显示时长
     */
    public EasyWindow setDuration(int duration) {
        mDuration = duration;
     ...
     * 设置生命周期监听
     */
    public EasyWindow setOnWindowLifecycle(OnWindowLifecycle listener) {
     ...
     */
    public EasyWindow setDecorView(ViewGroup viewGroup) {
     ...
     * 设置内容布局
     */
    public EasyWindow setContentView(int id) {
     ...
     * 设置可见状态
     */
    public EasyWindow setVisibility(int id, int visibility) {
     ...
     * 设置文本
     */
    public EasyWindow setText(int id) {
        return setText(android.R.id.message, id);
    }

    public EasyWindow setText(int viewId, int stringId) {
        return setText(viewId, mContext.getResources().getString(stringId));
    }

    public EasyWindow setText(CharSequence text) {
        return setText(android.R.id.message, text);
    }

    public EasyWindow setText(int id, CharSequence text) {
     ...
     * 设置字体颜色
     */
    public EasyWindow setTextColor(int id, int color) {
     ...
     * 设置字体大小
     */
    public EasyWindow setTextSize(int id, float size) {
        ((TextView) findViewById(id)).setTextSize(size);
        return this;
    }

    public EasyWindow setTextSize(int id, int unit, float size) {
     ...
     * 设置提示
     */
    public EasyWindow setHint(int viewId, int stringId) {
        return setHint(viewId, mContext.getResources().getString(stringId));
    }

    public EasyWindow setHint(int id, CharSequence text) {
     ...
     * 设置提示文本颜色
     */
    public EasyWindow setHintColor(int id, int color) {
     ...
     * 设置背景
     */
    public EasyWindow setBackground(int viewId, int drawableId) {
        Drawable drawable;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public EasyWindow setBackground(int id, Drawable drawable) {
     ...
     * 设置图片
     */
    public EasyWindow setImageDrawable(int viewId, int drawableId) {
        Drawable drawable;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawable = mContext.getDrawable(drawableId);
        } else {
    ...
    public EasyWindow setImageDrawable(int viewId, Drawable drawable) {
     ...
     * 设置点击事件
     */
    public EasyWindow setOnClickListener(OnClickListener<? extends View> listener) {
        return setOnClickListener(mDecorView, listener);
    }

    public EasyWindow setOnClickListener(int id, OnClickListener<? extends View> listener) {
        return setOnClickListener(findViewById(id), listener);
    }

    private EasyWindow setOnClickListener(View view, OnClickListener<? extends View> listener) {
     ...
     * 设置长按事件
     */
    public EasyWindow setOnLongClickListener(OnLongClickListener<? extends View> listener) {
        return setOnLongClickListener(mDecorView, listener);
    }

    public EasyWindow setOnLongClickListener(int id, OnLongClickListener<? extends View> listener) {
        return setOnLongClickListener(findViewById(id), listener);
    }

    private EasyWindow setOnLongClickListener(View view, OnLongClickListener<? extends View> listener) {
        // 如果当前是否设置了不可触摸，如果是就擦除掉
        removeWindowFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
     ...
     * 设置触摸事件
     */
    public EasyWindow setOnTouchListener(OnTouchListener<? extends View> listener) {
        return setOnTouchListener(mDecorView, listener);
    }

    public EasyWindow setOnTouchListener(int id, OnTouchListener<? extends View> listener) {
        return setOnTouchListener(findViewById(id), listener);
    }

    private EasyWindow setOnTouchListener(View view, OnTouchListener<? extends View> listener) {
        // 当前是否设置了不可触摸，如果是就擦除掉
        removeWindowFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
